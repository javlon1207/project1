...
<html>
   ...
   <body>
     <div class="container">
      <br />
      <h3 align="center">Импорт данных в информационную систему</h3>
      <br />
        <div class="panel panel-default">
          <div class="panel-heading">
              Импорт данных оприходированных ТМЦ в информационную систему в формате Excel (.xls)
          </div>
          ...
          <div class="table-responsive">
           <span id="message"></span>
              <form method="post" id="import_excel_form" enctype="multipart/form-data">
                <table class="table">
                  <tr>
                    <td width="25%" align="right">Выберите файл (excel)</td>
